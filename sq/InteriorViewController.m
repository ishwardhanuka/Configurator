...
- (void)setFirstTableDataSource:(NSArray*)folderList
{
    ...
    for(NSString *folder in folderList)
    {
        ...
        else if([folder isEqualToString:@"Lower"])
        {
            ...
            beginsWithRequirement = [NSString stringWithFormat:@"%@_int%@_Lower_",name,viewString];
            predicate = [NSPredicate predicateWithFormat:@"SELF BEGINSWITH[cd] %@", beginsWithRequirement];
            subArray = [directoryContents filteredArrayUsingPredicate:predicate];
        ...
        else if([folder isEqualToString:@"Seat Outer"])
        {
            ...
            beginsWithRequirement = [NSString stringWithFormat:@"%@_int%@_Seat Outer_",name,viewString];
            predicate = [NSPredicate predicateWithFormat:@"SELF BEGINSWITH[cd] %@", beginsWithRequirement];
            subArray = [directoryContents filteredArrayUsingPredicate:predicate];
        ...
        else if([folder isEqualToString:@"Upper"])
        {
            ...
            beginsWithRequirement = [NSString stringWithFormat:@"%@_int%@_Upper_",name,viewString];
            predicate = [NSPredicate predicateWithFormat:@"SELF BEGINSWITH[cd] %@", beginsWithRequirement];
            subArray = [directoryContents filteredArrayUsingPredicate:predicate];
        ...
        else if([folder isEqualToString:@"Upper IP"])
        {
            ...
            beginsWithRequirement = [NSString stringWithFormat:@"%@_int%@_Upper IP_",name,viewString];
            predicate = [NSPredicate predicateWithFormat:@"SELF BEGINSWITH[cd] %@", beginsWithRequirement];
            subArray = [directoryContents filteredArrayUsingPredicate:predicate];
        ...
        else if([folder isEqualToString:@"Upper Stitch"])
        {
            ...
            beginsWithRequirement = [NSString stringWithFormat:@"%@_int%@_Upper Stitch_",name,viewString];
            predicate = [NSPredicate predicateWithFormat:@"SELF BEGINSWITH[cd] %@", beginsWithRequirement];
            subArray = [directoryContents filteredArrayUsingPredicate:predicate];
        ...
        else if([folder isEqualToString:@"Lower Stitch"])
        {
            ...
            beginsWithRequirement = [NSString stringWithFormat:@"%@_int%@_Lower Stitch_",name,viewString];
            predicate = [NSPredicate predicateWithFormat:@"SELF BEGINSWITH[cd] %@", beginsWithRequirement];
            subArray = [directoryContents filteredArrayUsingPredicate:predicate];
